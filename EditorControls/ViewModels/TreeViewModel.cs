...
namespace NotionPlay.EditorControls.ViewModels
{
    ...
    public partial class TreeItemViewModel
    {
        ...
        {
            StateIcon = newValue ? OpenedSVG : ClosedSVG;
            ItemsVisibility = newValue ? Visibility.Visible : Visibility.Collapsed;
        }
